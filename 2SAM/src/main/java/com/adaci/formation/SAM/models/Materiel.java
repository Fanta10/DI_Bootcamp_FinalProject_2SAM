...
public class Materiel {
    ...
    private String code;
    @Column(name="libelle", length = 35, nullable = false)
    private String libelle;
    @Column(name="marque", length = 35, nullable = false)
    private String marque;
    @Column(name="modele", length = 35, nullable = false)
    private String modele;
    @Column(name="montant", length = 35, nullable = false)
    private int montant;
    @Column(name="deb_garantie", length = 10, nullable = false)
    private Date debut_garantie;
    @Column(name="fin_garantie", length = 10)
    private Date fin_garantie;
    @Column(name="num_serie", length = 35, nullable = false)
    private String num_serie;
    @Column(name="date_enregistrement", length = 10, nullable = false)
    private Date date_enregistrement;
    @Column(name="date_mise_dispos", length = 10, nullable = false)
    private Date date_utilisation;
    @Column(name="duree_utisation", length = 10, nullable = false)
    ...
    @JoinColumn(name = "StatutMateriel_id", nullable = false)
